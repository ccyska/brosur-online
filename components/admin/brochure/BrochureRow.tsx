...
export default function BrochureRow({ brochure, onDelete }: BrochureRowProps) {
  return (
    <tr className="border-b hover:bg-gray-50">
      ...
      <td className="font-medium">{brochure.title}</td>
      ...
      <td>
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-lg  bg-[#F5A000] px-4 py-2 text-sm font-medium text-white hover:bg-orange-600"
        >
          <Package size={16} />
          Kelola Paket
        </Link>
